...
require 'C:\Users\Nicollas\Documents\GitHub\boletophp\src\Boleto.php';
...
<HEAD>
    <TITLE><?php echo $boleto->identificacao; ?></TITLE>
        ...
        <TD valign=top class=cp>
            <DIV ALIGN="left">
                ...
                <li>Caso tenha problemas ao imprimir, copie a seqüencia numérica abaixo e pague no caixa eletrônico ou no internet banking:<br><br>
                    <span class="ld2">
                Linha Digitável: &nbsp;<?php echo $boleto->linha_digitavel ?><br>
                Valor: &nbsp;&nbsp;R$ <?php echo $boleto->valor_boleto ?><br>
              </span>
            </DIV>
        </td>
    </tr>
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
    <tr>
        ...
        <td class=ti width=455><?php echo $boleto->identificacao; ?> <?php echo isset($boleto->cpf_cnpj) ? "<br>" . $boleto->cpf_cnpj : '' ?><br>
            <?php echo $boleto->endereco; ?><br>
            <?php echo $boleto->cidade_uf; ?><br>
        </td>
...
<table cellspacing=0 cellpadding=0 width=666 border=0>
    <tr>
        ...
        <td class=cpt width=58 valign=bottom>
            <div align=center>
                <font class=bc><?php echo $boleto->codigo_banco_com_dv ?></font>
            </div>
        </td>
        <td width=3 valign=bottom><img height=22 src=imagens/3.png width=2 border=0></td>
        <td class=ld align=right width=453 valign=bottom><span class=ld>
          <span class="campotitulo">
            <?php echo $boleto->linha_digitavel ?>
          </span></span></td>
    </tr>
    <tbody>
    <tr>
...
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=cp valign=top colspan=3 height=12>
          <span class="campo">
            <?php echo $boleto->numero_documento ?>
          </span>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        <td class=cp valign=top width=132 height=12>
          <span class="campo">
            <?php echo $boleto->cpf_cnpj ?>
          </span>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        <td class=cp valign=top width=134 height=12>
          <span class="campo">
            <?php echo ($boleto->data_venc != "") ? $boleto->data_vencimento : "Contra Apresentação" ?>
          </span>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        <td class=cp valign=top align=right width=180 height=12>
          <span class="campo">
            <?php echo $boleto->valor_boleto ?>
          </span>
        </td>
    </tr>
    <tr>
...
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=cp width=564>
          <span class="campo">
            <?php echo $boleto->demonstrativo1 ?><br>
            <?php echo $boleto->demonstrativo2 ?><br>
            <?php echo $boleto->demonstrativo3 ?><br>
          </span>
        </td>
        <td width=7></td>
        <td width=88></td>
...
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=cp valign=top align=right width=180 height=12>
          <span class="campo">
            <?php echo ($boleto->data_vencimento != "") ? $boleto->data_vencimento : "Contra Apresentação" ?>
          </span>
        </td>
    </tr>
    <tr>
...
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=cp valign=top width=113 height=12>
            <div align=left>
            <span class="campo">
              <?php echo $boleto->data_documento ?>
            </span>
            </div>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        ...
        <td class=cp valign=top width=82 height=12>
            <div align=left>
            <span class="campo">
              <?php echo $boleto->data_processamento ?>
            </span>
            </div>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
...
<table cellspacing=0 cellpadding=0 border=0>
    ...
    <tr>
        ...
        <td class=cp valign=top width=72>
          <span class="campo">
            <?php echo $boleto->valor_unitario ?>
          </span>
        </td>
        <td class=cp valign=top width=7 height=12> <img height=12 src=imagens/1.png width=1 border=0></td>
        <td class=cp valign=top align=right width=180 height=12>
...
<table cellspacing=0 cellpadding=0 width=666 border=0>
    ...
    <tr>
        ...
        <td valign=top width=468 rowspan=5>
            ...
            <FONT class=campo>
              <?php echo $boleto->instrucoes1; ?><br>
              <?php echo $boleto->instrucoes2; ?><br>
              <?php echo $boleto->instrucoes3; ?><br>
              <?php echo $boleto->instrucoes4; ?></FONT><br><br>
          </span>
        </td>
...
<TABLE cellSpacing=0 cellPadding=0 width=666 border=0>
    <TBODY>
    <TR>
        <TD vAlign=bottom align=left height=50><?php $boleto->fbarcode($boleto->codigo_barras); ?>
        </TD>
    </tr>
    </tbody>
</table>
