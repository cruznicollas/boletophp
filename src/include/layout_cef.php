...
<BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
        ...
        <DIV ALIGN="left">
          <p>
            ...
            <li>Caso tenha problemas ao imprimir, copie a seqüencia numérica abaixo e pague no caixa eletrônico ou no internet banking:<br><br>
              <span class="ld2">
                &nbsp;&nbsp;&nbsp;&nbsp;Linha Digitável: &nbsp;<?php echo $dados_boleto["linha_digitavel"] ?><br>
                &nbsp;&nbsp;&nbsp;&nbsp;Valor: &nbsp;&nbsp;R$ <?php echo $dados_boleto["valor_boleto"] ?><br>
              </span>
        </DIV>
      </td>
    </tr>
  ...
  <table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
    <tr>
      ...
      <td class=ti width=455><?php echo $dados_boleto["identificacao"]; ?> <?php echo isset($dados_boleto["cpf_cnpj"]) ? "<br>" . $dados_boleto["cpf_cnpj"] : '' ?><br>
        <?php echo $dados_boleto["endereco"]; ?><br>
        <?php echo $dados_boleto["cidade_uf"]; ?><br>
      </td>
  ...
  <table cellspacing=0 cellpadding=0 width=666 border=0>
    <tr>
      ...
      <td class=cpt width=58 valign=bottom>
        <div align=center>
          <font class=bc><?php echo $dados_boleto["codigo_banco_com_dv"] ?></font>
        </div>
      </td>
      <td width=3 valign=bottom><img height=22 src=imagens/3.png width=2 border=0></td>
      <td class=ld align=right width=453 valign=bottom><span class=ld>
          <span class="campotitulo">
            <?php echo $dados_boleto["linha_digitavel"] ?>
          </span></span></td>
    </tr>
    <tbody>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class=cp valign=top colspan=3 height=12>
          <span class="campo">
            <?php echo $dados_boleto["numero_documento"] ?>
          </span>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        <td class=cp valign=top width=132 height=12>
          <span class="campo">
            <?php echo $dados_boleto["cpf_cnpj"] ?>
          </span>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        <td class=cp valign=top width=134 height=12>
          <span class="campo">
            <?php echo ($data_venc != "") ? $dados_boleto["data_vencimento"] : "Contra Apresentação" ?>
          </span>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        <td class=cp valign=top align=right width=180 height=12>
          <span class="campo">
            <?php echo $dados_boleto["valor_boleto"] ?>
          </span>
        </td>
      </tr>
      <tr>
  ...
  <table cellspacing=0 cellpadding=0 border=0>
    <tbody>
      <tr>
        ...
        <td class=ct width=7 height=12></td>
        <td class=ct width=88>Autenticaçãomecânica</td>
      </tr>
      <tr>
        <td width=7></td>
        <td class=cp width=564>
          <span class="campo">
            <?php echo $dados_boleto["demonstrativo1"] ?><br>
            <?php echo $dados_boleto["demonstrativo2"] ?><br>
            <?php echo $dados_boleto["demonstrativo3"] ?><br>
          </span>
        </td>
        <td width=7></td>
        <td width=88></td>
  ...
  <table cellspacing=0 cellpadding=0 border=0>
    <tbody>
      <tr>
        ...
        <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
        <td class=ct valign=top width=180 height=13>Agencia/Codigo
          cedente</td>
      </tr>
      <tr>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class=cp valign=top width=113 height=12>
          <div align=left>
            <span class="campo">
              <?php echo $dados_boleto["data_documento"] ?>
            </span>
          </div>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        ...
        <td class=cp valign=top width=62 height=12>
          <div align=left><span class="campo">
              <?php echo $dados_boleto["especie_doc"] ?>
            </span>
          </div>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        ...
        <td class=cp valign=top width=82 height=12>
          <div align=left>
            <span class="campo">
              <?php echo $dados_boleto["data_processamento"] ?>
            </span>
          </div>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class=cp valign=top width=83>
          <div align=left> <span class="campo">
              <?php echo $dados_boleto["carteira"] ?>
            </span></div>
        </td>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        ...
        <td class=cp valign=top width=72>
          <span class="campo">
            <?php echo $dados_boleto["valor_unitario"] ?>
          </span>
        </td>
        <td class=cp valign=top width=7 height=12> <img height=12 src=imagens/1.png width=1 border=0></td>
        <td class=cp valign=top align=right width=180 height=12>
      ...
      <tr>
        ...
        <td valign=top width=468 rowspan=5>
          <font class=ct>Instruções
            ...
            <FONT class=campo>
              <?php echo $dados_boleto["instrucoes1"]; ?><br>
              <?php echo $dados_boleto["instrucoes2"]; ?><br>
              <?php echo $dados_boleto["instrucoes3"]; ?><br>
              <?php echo $dados_boleto["instrucoes4"]; ?></FONT><br><br>
          </span>
        </td>
  ...
  <table cellspacing=0 cellpadding=0 border=0>
    <tbody>
      <tr>
        <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
        <td class=cp valign=top width=659 height=12><span class="campo">
            <?php echo $dados_boleto["endereco1"] ?>
          </span>
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        ...
        <td class=cp valign=top width=472 height=13>
          <span class="campo">
            <?php echo $dados_boleto["endereco2"] ?>
          </span>
        </td>
        <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width=666 border=0>
    <TBODY>
      <TR>
        <TD vAlign=bottom align=left height=50><?php fbarcode($dados_boleto["codigo_barras"]); ?>
        </TD>
      </tr>
    </tbody>
  </table>
