...
$valor = formata_numero($dados_boleto["valor_boleto"], 10, 0, "valor");
//agencia é 4 digitos
$agencia = formata_numero($dados_boleto["agencia"], 4, 0);
//conta é 5 digitos
$conta = formata_numero($dados_boleto["conta"], 5, 0);
//dv da conta
$conta_dv = formata_numero($dados_boleto["conta_dv"], 1, 0);
//carteira é 2 caracteres
$carteira = $dados_boleto["carteira"];

//nosso número (sem dv) é 10 digitos
$nnum = $dados_boleto["inicio_nosso_numero"] . formata_numero($dados_boleto["nosso_numero"], 8, 0);
//dv do nosso número
$dv_nosso_numero = digitoVerificador_nossonumero($nnum);
$nossonumero_dv = "$nnum$dv_nosso_numero";

//conta cedente (sem dv) é 11 digitos
$conta_cedente = formata_numero($dados_boleto["conta_cedente"], 11, 0);
//dv da conta cedente
$conta_cedente_dv = formata_numero($dados_boleto["conta_cedente_dv"], 1, 0);
...
$dados_boleto["codigo_barras"] = $linha;
$dados_boleto["linha_digitavel"] = monta_linha_digitavel($linha);
$dados_boleto["agencia_codigo"] = $agencia_codigo;
$dados_boleto["nosso_numero"] = $nossonumero;
$dados_boleto["codigo_banco_com_dv"] = $codigo_banco_com_dv;
